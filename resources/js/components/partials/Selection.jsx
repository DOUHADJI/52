...
const Selection = ({label, setSpecialite,specialite, options, error}) => {
    return(
        <>
            <div className="flex justify-between items-center gap-5 ">
                ...
                <Radio.Group  value={specialite}  onChange={setSpecialite} label={"choisissez une option"} orientation='vertical' size='sm'>
